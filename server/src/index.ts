...
(async () => {
	...
	id SERIAL PRIMARY KEY,
	hotel SERIAL REFERENCES hotel(id),
	number INTEGER,
	price FLOAT,
	capacity INTEGER,
	view TEXT,
...
// VALUES
// (1, 101, 100, 2, 'City View', ARRAY['WiFi', 'TV'], TRUE, FALSE),
// (2, 102, 150, 4, 'Ocean View', ARRAY['WiFi', 'TV', 'Mini Bar'], TRUE, FALSE),
// (3, 103, 200, 6, 'Mountain View', ARRAY['WiFi', 'TV', 'Jacuzzi'], TRUE, FALSE),
// (4, 104, 120, 3, 'City View', ARRAY['WiFi', 'TV'], TRUE, FALSE),
// (5, 105, 90, 2, 'City View', ARRAY['WiFi', 'TV'], TRUE, FALSE)`);
